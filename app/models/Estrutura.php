...
class Estrutura extends ActiveRecord
{
    public function setup()
    {
        ...
        $this->has_many('categories', array('through' => 'estrutura_categories', 'local_field' => 'estrutura_id'));
        
        $this->has_many('EstruturaFile as files');
    }
    ...
    public function before_save()
    {
        ...
        if ($this->slug != $slug) {
            $count = ActiveRecord::model('Estrutura')->count(array('conditions' => 'slug like "' . $slug . '%"'));
