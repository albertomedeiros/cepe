        ...
        <div class="header-mobile">
            ...
            <nav class="menu">
                <ul class="principal">
					...
					<li class="submenu">
                        <a title="Produtos e Serviços">carambola</a>
						<ul>
                            <div class="title">
                                <span class="voltar">voltar</span>
                                <p>carambola</p>
                            ...
                            <div class="scroll">
                                <li><a href="<?= $this->site_url('./') ?>" title="tamarindo">tamarindo</a></li>
                                <li><a href="<?= $this->site_url('certificacao') ?>"
                                       title="cuscuz">cuscuz</a></li>
            ...
            <div class="container">
                ...
                <nav class="menu">
                    ...
                    <ul class="principal">
                        ...
                        <li><a href="<?= $this->site_url('concursos') ?>" title="Prêmios">Prêmios</a>
                        </li>
                    </ul>
                </nav>
        ...
        <div class="container">
            <ul class="menu-rodape">
                <li>
                    ...
                    <a href="<?= $this->site_url('noticias') ?>" title="notícias">Notícias</a>
...
<script src="<?= $this->public_url('js/app/main.js') ?>"></script>
