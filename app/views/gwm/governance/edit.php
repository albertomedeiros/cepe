<?php $this->title_bar = '<li><a href="' . $this->site_url('governance') . '">Governança Corporativa</a>/</li><li><span>' . (!$this->object->exists() ? 'Adicionar novo' : 'Editar') . '</span></li>' ?>

<h2><?= !$this->object->exists() ? 'Inserir' : 'Editar' ?> governança corporativa</h2>
...
<a href="<?= $this->site_url('governance') ?>" class="cancel-form">Cancelar</a>
