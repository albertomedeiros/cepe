<?php $this->title_bar = '<li><a href="' . $this->site_url('bidding') . '">Licitações</a>/</li><li><span>' . (!$this->object->exists() ? 'Adicionar novo' : 'Editar') . '</span></li>' ?>

<h2><?= !$this->object->exists() ? 'Inserir' : 'Editar' ?> licitação</h2>
...
<a href="<?= $this->site_url('bidding') ?>" class="cancel-form">Cancelar</a>
