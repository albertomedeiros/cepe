<?php $this->title_bar = '<li><a href="' . $this->site_url('estrutura') . '">Estrutura Administrativa</a>/</li><li><span>' . (!$this->object->exists() ? 'Adicionar novo' : 'Editar') . '</span></li>' ?>

<h2><?= !$this->object->exists() ? 'Inserir' : 'Editar' ?> Estrutura Administrativa</h2>
...
<section id="main">
  ...
  <div class="row">
    <div class="span4" style="margin-bottom:15px;">
     <label for="text_field">Texto <?= Fishy_FormHelper::text_area('text', array(), array('class' => 'tinymce2')) ?></label>
   </div>
  </div>
...
<a href="<?= $this->site_url('estrutura') ?>" class="cancel-form">Cancelar</a>
