...
abstract class ActiveRecord
{
	...
	private function create_or_update()
	{
		...
		if ($this->exists()) {
			$this->before_update();
			/* Editado 4job Adicionei porque estava causando erro no unable */
	...
	{
		include_once "vendor/fishyfw/database/DbCommand.php";
		...
		return DbCommand::escape_string($data);//mysqli_real_escape_string(DbCommand::$connection, $data);
	}
