...
/**
 * This class provides some functions to forced download of files
 *
 * @author Wilker Lucio
 */
class Fishy_DownloadHelper
{
	public static function force_download($filename = '', $data = false, $enable_partial = true, $speedlimit = 0)
	{
		if ($filename == '') {
			return FALSE;
		}
