<?php
	define('FILESYSTEM_ROOT_PATH', str_replace('gwm' . DIRECTORY_SEPARATOR . 'js' . DIRECTORY_SEPARATOR . 'tinymce' . DIRECTORY_SEPARATOR . 'plugins' , '', dirname(__DIR__)));
	define('FILESYSTEM_UPLOAD_PATH', FILESYSTEM_ROOT_PATH . 'uploads' . DIRECTORY_SEPARATOR . 'data');

	// General
	$moxieManagerConfig['general.license'] = 'EPHX-PROD-PV6A-OPBF-ETBM-VSEZ-KOGR-MBWP';
	...
	$moxieManagerConfig['general.language'] = 'pt';
	...
	// Filesystem
	$moxieManagerConfig['filesystem.rootpath'] = FILESYSTEM_UPLOAD_PATH . '/files';
	...
	// IpAuthenticator
	$moxieManagerConfig['IpAuthenticator.ip_numbers'] = '127.0.0.1,66.147.225.45';
	...
	// Cache
	$moxieManagerConfig['cache.connection'] = "sqlite:" . FILESYSTEM_UPLOAD_PATH . "/storage/cache.s3db";

	// Storage
	$moxieManagerConfig['storage.engine'] = 'json';
	$moxieManagerConfig['storage.path'] = FILESYSTEM_UPLOAD_PATH . '/storage';
